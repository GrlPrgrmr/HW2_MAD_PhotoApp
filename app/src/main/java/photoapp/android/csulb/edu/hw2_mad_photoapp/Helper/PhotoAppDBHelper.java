package photoapp.android.csulb.edu.hw2_mad_photoapp.Helper;
...
public class PhotoAppDBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertRecord(Picture img)
    {
        try {
            SQLiteDatabase db = this.getWritableDatabase();
    ...
    public Picture getRow(int position) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            photo = new Picture(path,caption );
            cursor.close();
        }
    ...
    public List<Picture> readDBFull() {
